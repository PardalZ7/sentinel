/**
 * Sentinel Control Plane client for usecase-2.
 *
...
const SENTINEL_URL  = process.env.SENTINEL_URL  || 'http://localhost:8889';
const TOPOLOGY_ID   = process.env.SENTINEL_TOPOLOGY_ID || 'usecase-2';
